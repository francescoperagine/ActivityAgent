...
--
-- Host: 127.0.0.1:3306
-- Creato il: Lug 25, 2019 alle 09:10
...
--
-- Struttura della tabella `degreecourse_lecture`
--

DROP TABLE IF EXISTS `degreecourse_lecture`;
CREATE TABLE IF NOT EXISTS `degreecourse_lecture` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `user_degreecourse` (`ID`, `userID`, `classID`) VALUES
(1, 1, 2);
