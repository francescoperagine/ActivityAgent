    ...
    void setLessonList(JSONArray studentCareerData) {
        ...
        for (int i=0; i< studentCareerData.length(); i++) {
            ...
            try {
                ...
                lesson.lessonID = o.optInt(Constants.KEY_CLASS_LESSON_ID);
                ...
                lesson.timeStart = lesson.getTimestampDateFromString(o.optString(Constants.KEY_CLASS_LESSON_TIME_START));
                lesson.timeEnd = lesson.getTimestampDateFromString(o.optString(Constants.KEY_CLASS_LESSON_TIME_END));
                lesson.lessonSummary = o.optString(Constants.KEY_CLASS_LESSON_SUMMARY);
                lesson.lessonDescription = o.optString(Constants.KEY_CLASS_LESSON_DESCRIPTION);
